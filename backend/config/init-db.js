...
async function initDB() {
  ...
  const defaultContents = [
      ...
      ['about_stat1_value', 'Sobre Nosotros: Stat 1 valor', '+25', 'text'],
      ['about_stat1_label', 'Sobre Nosotros: Stat 1 etiqueta', 'Años de Experiencia', 'text'],
      ['about_stat1_desc', 'Sobre Nosotros: Stat 1 descripción', 'Saber hacer acumulado por nuestro equipo senior.', 'text'],
      ['about_stat2_value', 'Sobre Nosotros: Stat 2 valor', '2018', 'text'],
      ['about_stat2_label', 'Sobre Nosotros: Stat 2 etiqueta', 'Año de Fundación', 'text'],
      ['about_stat2_desc', 'Sobre Nosotros: Stat 2 descripción', 'Nacimiento de Isla Cloud Solutions en España.', 'text'],
      ['about_stat3_value', 'Sobre Nosotros: Stat 3 valor', '35%', 'text'],
      ['about_stat3_label', 'Sobre Nosotros: Stat 3 etiqueta', 'Crecimiento Anual', 'text'],
      ['about_stat3_desc', 'Sobre Nosotros: Stat 3 descripción', 'Incremento sostenido en facturación global.', 'text'],
      ['about_stat4_value', 'Sobre Nosotros: Stat 4 valor', '65%', 'text'],
      ['about_stat4_label', 'Sobre Nosotros: Stat 4 etiqueta', 'Nuevos Clientes', 'text'],
      ['about_stat4_desc', 'Sobre Nosotros: Stat 4 descripción', 'Confianza renovada por líderes del sector.', 'text'],
      ['about_pillar1_title', 'Sobre Nosotros: Pilar 1 título', 'Visión Estratégica', 'text'],
      ['about_pillar1_desc', 'Sobre Nosotros: Pilar 1 descripción', 'Convertirnos en el socio tecnológico indispensable, no en un simple proveedor.', 'text'],
      ['about_pillar2_title', 'Sobre Nosotros: Pilar 2 título', 'Cercanía Real', 'text'],
      ['about_pillar2_desc', 'Sobre Nosotros: Pilar 2 descripción', 'Trato personalizado y humano como principal ventaja competitiva.', 'text'],
      ['about_cta_title', 'Sobre Nosotros: CTA título', '¿Listo para escalar tu infraestructura?', 'text'],
      ['about_cta_subtitle', 'Sobre Nosotros: CTA subtítulo', 'Nuestra amplia cartera de clientes avala nuestra resolutividad. Sea cual sea tu desafío, en Isla Cloud Solutions tenemos la arquitectura adecuada.', 'text'],
      ['about_cta_button', 'Sobre Nosotros: CTA botón', 'Solicitar consultoría gratuita', 'text'],
