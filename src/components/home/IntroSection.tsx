...
const IntroSection = () => {
  ...
  return (
    <section className="relative z-0 overflow-visible bg-background pt-20 md:pt-28 pb-20 md:pb-28 lg:pb-32">
      <div className="container mx-auto px-4">
        <motion.p
          ...
          className="text-xl md:text-2xl lg:text-3xl font-heading font-medium leading-relaxed max-w-5xl mx-auto text-justify animated-gradient-text"
        >
          {introText}
        </motion.p>
      </div>
