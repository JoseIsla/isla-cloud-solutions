    ...
    <PanelLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" onClick={() => setEditing({ question: '', answer: '', sort_order: 0, is_active: 1 })}>
            <Plus size={16} /> Nueva
          </Button>
        </div>
        ...
        <div className="space-y-2">
          ...
          {faqs.map((f) => (
            <div key={f.id} className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border hover:border-primary/15 transition-colors group">
